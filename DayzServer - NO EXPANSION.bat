...
set mods=@CF;@eAI;@Namalsk Island;@Namalsk Survival;@Community-Online-Tools;@Dabs Framework;@SkyZ - Skybox Overhaul;@sVisual;@sGunplay;@BaseBuildingPlus;@Breachingcharge;@Code Lock;@Forced First Person Combat;@StaminaSettings;@AdditionalFrozenFoodNamalsk;@Increased Lumens;@BetterClutterCutters;@BadgerBuildings;@BuildingsMegaModPack;@Mists (Atmosphere);@Forever_Lights_and_Campfires;@Fog mist smoke particles;@ParticlePointsPlacement;@ZStuff;@DayZ Editor Loader;@OV_AllInOne;@Buggy;@dbo_surfaces_nam;@Blackouts Corvette;@GoreZ;@GasMaskAddons;@RadZone;@WindstridesClothingPack;@AlienMoon;@FS;@FS_English_Translation;@BuilderItems;
::mods (@modName;@anotherModname;@mod)
::set servermods=
